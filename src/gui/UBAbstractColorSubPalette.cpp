#include "UBAbstractColorSubPalette.h"


const QString UBAbstractColorSubPalette::styleSheetLeftGroupedButton =   "QToolButton{background: qlineargradient(x1: 0, y1: 0.49, x2: 0, y2: 0.5,"
...
const QString UBAbstractColorSubPalette::styleSheetCenterGroupedButton =     "QToolButton{background: qlineargradient(x1: 0, y1: 0.49, x2: 0, y2: 0.5, stop: 0 #d3d3d3, stop: 1  #c4c4c4);"
                                                                                    "margin-top: 1px;"
                                                                                    "margin-right: 0px;"
                                                                                    "margin-left: 0px;"
...
const QString UBAbstractColorSubPalette::styleSheetRightGroupedButton =  "QToolButton{background: qlineargradient(x1: 0, y1: 0.49, x2: 0, y2: 0.5, stop: 0 #d3d3d3, stop: 1  #c4c4c4);"
                                                                                "margin-top: 1px;"
                                                                                "margin-left: 0px;"
                                                                                "border: 1px solid #444444;"
                                                                                "border-left: 1px solid transparent;"
...
UBAbstractColorSubPalette::UBAbstractColorSubPalette(QWidget *parent, Qt::Orientation orient) :
...
UBAbstractColorSubPalette::UBAbstractColorSubPalette(Qt::Orientation orient, QWidget *parent) :
...
void UBAbstractColorSubPalette::togglePalette()
{
...
void UBAbstractColorSubPalette::triggerAction(QAction *action)
{
    Q_UNUSED(action)
    // NOOP
}

void UBAbstractColorSubPalette::focusOutEvent(QFocusEvent *)
{
    hide(); // hide subPalette when it loses focus (for exemple : clic anywhere else)
}

void UBAbstractColorSubPalette::mouseMoveEvent(QMouseEvent *)
{
