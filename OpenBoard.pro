...
win32 {
   ...
   THIRD_PARTY_PATH=../NeodBoard-ThirdParty
   ...
   RC_FILE = resources/win/NeodBoard.rc
   CONFIG += axcontainer
...
#    QMAKE_CFLAGS += -fopenmp
 #   QMAKE_CXXFLAGS += -fopenmp
  #  QMAKE_LFLAGS += -fopenmp
   ...
   UB_MACX_EXTRAS.files = "resources/macx/Save PDF to NeodBoard.workflow"
   UB_MACX_EXTRAS.path = "$$RESOURCES_DIR"
   UB_I18N.path = $$DESTDIR/i18n # not used

    exists(resources/i18n/NeodBoard_ar.qm) {
        TRANSLATION_ar.files = resources/i18n/NeodBoard_ar.qm \
            resources/i18n/Localizable.strings
        TRANSLATION_ar.path = "$$RESOURCES_DIR/ar.lproj"
        QMAKE_BUNDLE_DATA += TRANSLATION_ar
    }
    exists(resources/i18n/NeodBoard_bg.qm) {
        TRANSLATION_bg.files = resources/i18n/NeodBoard_bg.qm \
            resources/i18n/Localizable.strings
        TRANSLATION_bg.path = "$$RESOURCES_DIR/bg.lproj"
        QMAKE_BUNDLE_DATA += TRANSLATION_bg
    }
    exists(resources/i18n/NeodBoard_ca.qm) {
        TRANSLATION_ca.files = resources/i18n/NeodBoard_ca.qm \
            resources/i18n/Localizable.strings
        TRANSLATION_ca.path = "$$RESOURCES_DIR/ca.lproj"
        QMAKE_BUNDLE_DATA += TRANSLATION_ca
    }
    exists(resources/i18n/NeodBoard_cs.qm) {
        TRANSLATION_cs.files = resources/i18n/NeodBoard_cs.qm \
            resources/i18n/localizable.strings
        TRANSLATION_cs.path = "$$RESOURCES_DIR/cs.lproj"
        QMAKE_BUNDLE_DATA += TRANSLATION_cs
    }
    exists(resources/i18n/NeodBoard_da.qm) {
        TRANSLATION_da.files = resources/i18n/NeodBoard_da.qm \
            resources/i18n/Localizable.strings
        TRANSLATION_da.path = "$$RESOURCES_DIR/da.lproj"
        QMAKE_BUNDLE_DATA += TRANSLATION_da
    }
    exists(resources/i18n/NeodBoard_de.qm) {
        TRANSLATION_de.files = resources/i18n/NeodBoard_de.qm \
            resources/i18n/Localizable.strings
        TRANSLATION_de.path = "$$RESOURCES_DIR/de.lproj"
        QMAKE_BUNDLE_DATA += TRANSLATION_de
    }
    exists(resources/i18n/NeodBoard_el.qm) {
        TRANSLATION_el.files = resources/i18n/NeodBoard_el.qm \
            resources/i18n/Localizable.strings
        TRANSLATION_el.path = "$$RESOURCES_DIR/el.lproj"
        QMAKE_BUNDLE_DATA += TRANSLATION_el
    }
   exists(resources/i18n/NeodBoard_en.qm) {
       TRANSLATION_en.files = resources/i18n/NeodBoard_en.qm \
           resources/i18n/Localizable.strings
       TRANSLATION_en.path = "$$RESOURCES_DIR/en.lproj"
       QMAKE_BUNDLE_DATA += TRANSLATION_en
   }
   exists(resources/i18n/NeodBoard_en_UK.qm) {
       TRANSLATION_en_UK.files = resources/i18n/NeodBoard_en_UK.qm \
           resources/i18n/Localizable.strings
       TRANSLATION_en_UK.path = "$$RESOURCES_DIR/en_UK.lproj"
       QMAKE_BUNDLE_DATA += TRANSLATION_en_UK
   }
   exists(resources/i18n/NeodBoard_es.qm) {
       TRANSLATION_es.files = resources/i18n/NeodBoard_es.qm \
           resources/i18n/Localizable.strings
       TRANSLATION_es.path = "$$RESOURCES_DIR/es.lproj"
       QMAKE_BUNDLE_DATA += TRANSLATION_es
   }
   exists(resources/i18n/NeodBoard_eu.qm) {
       TRANSLATION_eu.files = resources/i18n/NeodBoard_eu.qm \
           resources/i18n/localizable.strings
       TRANSLATION_eu.path = "$$RESOURCES_DIR/eu.lproj"
       QMAKE_BUNDLE_DATA += TRANSLATION_eu
   }
   exists(resources/i18n/NeodBoard_fr.qm) {
       TRANSLATION_fr.files = resources/i18n/NeodBoard_fr.qm \
           resources/i18n/Localizable.strings
       TRANSLATION_fr.path = "$$RESOURCES_DIR/fr.lproj"
       QMAKE_BUNDLE_DATA += TRANSLATION_fr
   }
   exists(resources/i18n/NeodBoard_fr_CH.qm) {
       TRANSLATION_fr_CH.files = resources/i18n/NeodBoard_fr_CH.qm \
           resources/i18n/Localizable.strings
       TRANSLATION_fr_CH.path = "$$RESOURCES_DIR/fr_CH.lproj"
       QMAKE_BUNDLE_DATA += TRANSLATION_fr_CH
   }
   exists(resources/i18n/NeodBoard_gl.qm) {
       TRANSLATION_gl.files = resources/i18n/NeodBoard_gl.qm \
           resources/i18n/localizable.strings
       TRANSLATION_gl.path = "$$RESOURCES_DIR/gl.lproj"
       QMAKE_BUNDLE_DATA += TRANSLATION_gl
   }
   exists(resources/i18n/NeodBoard_hr.qm) {
       TRANSLATION_hr.files = resources/i18n/NeodBoard_hr.qm \
           resources/i18n/localizable.strings
       TRANSLATION_hr.path = "$$RESOURCES_DIR/hr.lproj"
       QMAKE_BUNDLE_DATA += TRANSLATION_hr
   }
   exists(resources/i18n/NeodBoard_hu.qm) {
       TRANSLATION_hu.files = resources/i18n/NeodBoard_hu.qm \
           resources/i18n/localizable.strings
       TRANSLATION_hu.path = "$$RESOURCES_DIR/hu.lproj"
       QMAKE_BUNDLE_DATA += TRANSLATION_hu
   }
   exists(resources/i18n/NeodBoard_it.qm) {
       TRANSLATION_it.files = resources/i18n/NeodBoard_it.qm \
           resources/i18n/Localizable.strings
       TRANSLATION_it.path = "$$RESOURCES_DIR/it.lproj"
       QMAKE_BUNDLE_DATA += TRANSLATION_it
   }
   exists(resources/i18n/NeodBoard_iw.qm) {
       TRANSLATION_iw.files = resources/i18n/NeodBoard_iw.qm \
           resources/i18n/Localizable.strings
       TRANSLATION_iw.path = "$$RESOURCES_DIR/iw.lproj"
       QMAKE_BUNDLE_DATA += TRANSLATION_iw
   }
   exists(resources/i18n/NeodBoard_ja.qm) {
       TRANSLATION_ja.files = resources/i18n/NeodBoard_ja.qm \
           resources/i18n/Localizable.strings
       TRANSLATION_ja.path = "$$RESOURCES_DIR/ja.lproj"
       QMAKE_BUNDLE_DATA += TRANSLATION_ja
   }
   exists(resources/i18n/NeodBoard_ko.qm) {
       TRANSLATION_ko.files = resources/i18n/NeodBoard_ko.qm \
           resources/i18n/Localizable.strings
       TRANSLATION_ko.path = "$$RESOURCES_DIR/ko.lproj"
       QMAKE_BUNDLE_DATA += TRANSLATION_ko
   }
   exists(resources/i18n/NeodBoard_mg.qm) {
       TRANSLATION_mg.files = resources/i18n/NeodBoard_mg.qm \
           resources/i18n/localizable.strings
       TRANSLATION_mg.path = "$$RESOURCES_DIR/mg.lproj"
       QMAKE_BUNDLE_DATA += TRANSLATION_mg
   }
   exists(resources/i18n/NeodBoard_nb.qm) {
       TRANSLATION_nb.files = resources/i18n/NeodBoard_nb.qm \
           resources/i18n/Localizable.strings
       TRANSLATION_nb.path = "$$RESOURCES_DIR/nb.lproj"
       QMAKE_BUNDLE_DATA += TRANSLATION_nb
   }
   exists(resources/i18n/NeodBoard_nl.qm) {
       TRANSLATION_nl.files = resources/i18n/NeodBoard_nl.qm \
           resources/i18n/Localizable.strings
       TRANSLATION_nl.path = "$$RESOURCES_DIR/nl.lproj"
       QMAKE_BUNDLE_DATA += TRANSLATION_nl
   }
   exists(resources/i18n/NeodBoard_pl.qm) {
       TRANSLATION_pl.files = resources/i18n/NeodBoard_pl.qm \
           resources/i18n/Localizable.strings
       TRANSLATION_pl.path = "$$RESOURCES_DIR/pl.lproj"
       QMAKE_BUNDLE_DATA += TRANSLATION_pl
   }
   exists(resources/i18n/NeodBoard_pt.qm) {
       TRANSLATION_pt.files = resources/i18n/NeodBoard_pt.qm \
           resources/i18n/Localizable.strings
       TRANSLATION_pt.path = "$$RESOURCES_DIR/pt.lproj"
       QMAKE_BUNDLE_DATA += TRANSLATION_pt
   }
   exists(resources/i18n/NeodBoard_pt_BR.qm) {
       TRANSLATION_pt_BR.files = resources/i18n/NeodBoard_pt_BR.qm \
           resources/i18n/Localizable.strings
       TRANSLATION_pt_BR.path = "$$RESOURCES_DIR/pt_BR.lproj"
       QMAKE_BUNDLE_DATA += TRANSLATION_pt_BR
   }
   exists(resources/i18n/NeodBoard_ro.qm) {
       TRANSLATION_ro.files = resources/i18n/NeodBoard_ro.qm \
           resources/i18n/Localizable.strings
       TRANSLATION_ro.path = "$$RESOURCES_DIR/ro.lproj"
       QMAKE_BUNDLE_DATA += TRANSLATION_ro
   }
   exists(resources/i18n/NeodBoard_ru.qm) {
       TRANSLATION_ru.files = resources/i18n/NeodBoard_ru.qm \
           resources/i18n/Localizable.strings
       TRANSLATION_ru.path = "$$RESOURCES_DIR/ru.lproj"
       QMAKE_BUNDLE_DATA += TRANSLATION_ru
   }
   exists(resources/i18n/NeodBoard_sk.qm) {
       TRANSLATION_sk.files = resources/i18n/NeodBoard_sk.qm \
           resources/i18n/Localizable.strings
       TRANSLATION_sk.path = "$$RESOURCES_DIR/sk.lproj"
       QMAKE_BUNDLE_DATA += TRANSLATION_sk
   }
   exists(resources/i18n/NeodBoard_sv.qm) {
       TRANSLATION_sv.files = resources/i18n/NeodBoard_sv.qm \
           resources/i18n/Localizable.strings
       TRANSLATION_sv.path = "$$RESOURCES_DIR/sv.lproj"
       QMAKE_BUNDLE_DATA += TRANSLATION_sv
   }
   exists(resources/i18n/NeodBoard_tr.qm) {
       TRANSLATION_tr.files = resources/i18n/NeodBoard_tr.qm \
           resources/i18n/Localizable.strings
       TRANSLATION_tr.path = "$$RESOURCES_DIR/tr.lproj"
       QMAKE_BUNDLE_DATA += TRANSLATION_tr
   }
   exists(resources/i18n/NeodBoard_uk.qm) {
       TRANSLATION_uk.files = resources/i18n/NeodBoard_uk.qm \
           resources/i18n/localizable.strings
       TRANSLATION_uk.path = "$$RESOURCES_DIR/uk.lproj"
       QMAKE_BUNDLE_DATA += TRANSLATION_uk
   }
   exists(resources/i18n/NeodBoard_zh.qm) {
       TRANSLATION_zh.files = resources/i18n/NeodBoard_zh.qm \
           resources/i18n/Localizable.strings
       TRANSLATION_zh.path = "$$RESOURCES_DIR/zh.lproj"
       QMAKE_BUNDLE_DATA += TRANSLATION_zh
   }
   exists(resources/i18n/NeodBoard_zh_CN.qm) {
       TRANSLATION_zh_CN.files = resources/i18n/NeodBoard_zh_CN.qm \
           resources/i18n/Localizable.strings
       TRANSLATION_zh_CN.path = "$$RESOURCES_DIR/zh_CN.lproj"
       QMAKE_BUNDLE_DATA += TRANSLATION_zh_CN
   }
   exists(resources/i18n/NeodBoard_zh_TW.qm) {
       TRANSLATION_zh_TW.files = resources/i18n/NeodBoard_zh_TW.qm \
           resources/i18n/Localizable.strings
   ...
   # For packger (release.macx.sh script) to know NeodBoard version
...
RESOURCES += resources/NeodBoard.qrc

# When adding a translation here, also add it in the macx part
TRANSLATIONS = resources/i18n/NeodBoard_ar.ts \
    resources/i18n/NeodBoard_bg.ts \
    resources/i18n/NeodBoard_ca.ts \
    resources/i18n/NeodBoard_cs.ts \
    resources/i18n/NeodBoard_da.ts \
    resources/i18n/NeodBoard_de.ts \
    resources/i18n/NeodBoard_el.ts \
    resources/i18n/NeodBoard_en.ts \
    resources/i18n/NeodBoard_en_UK.ts \
    resources/i18n/NeodBoard_es.ts \
    resources/i18n/NeodBoard_eu.ts \
    resources/i18n/NeodBoard_fr.ts \
    resources/i18n/NeodBoard_fr_CH.ts \
    resources/i18n/NeodBoard_gl.ts \
    resources/i18n/NeodBoard_hr.ts \
    resources/i18n/NeodBoard_hu.ts \
    resources/i18n/NeodBoard_it.ts \
    resources/i18n/NeodBoard_iw.ts \
    resources/i18n/NeodBoard_ja.ts \
    resources/i18n/NeodBoard_ko.ts \
    resources/i18n/NeodBoard_mg.ts \
    resources/i18n/NeodBoard_nb.ts \
    resources/i18n/NeodBoard_nl.ts \
    resources/i18n/NeodBoard_pl.ts \
    resources/i18n/NeodBoard_pt.ts \
    resources/i18n/NeodBoard_pt_BR.ts \
    resources/i18n/NeodBoard_ro.ts \
    resources/i18n/NeodBoard_ru.ts \
    resources/i18n/NeodBoard_sk.ts \
    resources/i18n/NeodBoard_sv.ts \
    resources/i18n/NeodBoard_tr.ts \
    resources/i18n/NeodBoard_uk.ts \
    resources/i18n/NeodBoard_zh.ts \
    resources/i18n/NeodBoard_zh_CN.ts \
    resources/i18n/NeodBoard_zh_TW.ts
